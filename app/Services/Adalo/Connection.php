...
class Connection
{
    ...
    public function __construct(string $apiCollectionId)
    {
        ...
        $this->url = sprintf('https://api.adalo.com/v0/apps/%1$s/collections/%2$s', $this->apiAppId, $this->apiCollectionId);
    ...
    //  * @return HTTP response
    //  */
    // public function persist(string $record)
    // {
    //     return Http::accept('application/json')
    //         ->withToken($this->bearerToken)
    //         ->post($this->url, [
